...
public class Factory {
    ...
    public Equipment createEquip (Integer id, String name, String size, String avail, String desc, Double price) {
        return new Equipment(id, name,size,avail,desc,price);
    }
